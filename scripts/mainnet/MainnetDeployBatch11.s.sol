...
contract Deploy is Script {
    ...
    function _deployVaults() internal {
        ...
        string[N] memory symbols = ["FNGL", "01ETH", "alluETH"];
        uint256[N] memory limits = [uint256(2000 ether), 1000 ether, 3000 ether];
        address[N] memory symbioticVaults = [
            address(0x43B05272F9d1ba626B56806C19C265a031b88d9c),
            0xf9Fc625e2471211e2e58790AAFa38231A8C9b76b,
            0x5b1885dcb66A6ec926AE12eC0e4215E99e3cE9bF
        ];
